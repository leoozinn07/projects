...
- Jornada do parceiro: `/parceiros` (landing) → conta → cadastro (CPF/CNPJ, revisão em até 2 dias úteis) → publicar experiências (no ar na hora; moderação depois, por denúncias) → conectar o Mercado Pago → operar reservas e vendas em `/parceiro`.
